...
// TPV new request for that user data in EEPROM or flash, HDCP key always located at 3F000
...
#define TOTAL_BANK_NUM              8 // (TOTAL_BANK_NUM-1) : current code bank
#else
...
#define DDCDPKEY_SECTOR_SIZE        1024
#define DDCDPKEY_STATUS_SIZE       	0x10
#define DDCDPKEY_STATUS_ADDR       	(PANEL_STATUS_ADDR     +PANEL_STATUS_SIZE)
#define DDCDPKEY_BUF_STATUS_ADDR    (PANEL_BUF_STATUS_ADDR +PANEL_STATUS_SIZE)
#define DDCDPKEY_SIZE              	256
#define DDCDPKEYSET_START           (GAMMA_START    +GAMMA_SECTOR_SIZE)//0x3B800
#define DDCDPKEYSET_BUF_START       (GAMMA_BUF_START+GAMMA_SECTOR_SIZE)
#endif
...
*/
//#define HDCPKEY_SIZE                304
#if HDCPKEY_IN_7F000 && ((CHIP_ID == CHIP_TSUM9 || CHIP_ID == CHIP_TSUMF) && ENABLE_CABLE_5V_EDID)

#elif HDCPKEY_IN_7F000	//120420 Modify
#define HDCPKEYSET_START            0xF000
#else
//#define HDCPKEYSET_START            FDATA_HDCPKEY_START_ADDR 	//130710 for new request
#endif



#if ENABLE_DP_INPUT	//121115 Modify
#if ENABLE_DP_EDID_IN_FLASH
#define DP_EDID_START            	0xE000
#endif
#endif

#if ENABLE_MHL	//enable mhl edid
#if ENABLE_MHL_EDID_IN_FLASH
#define MHL_EDID_START            	0xD000
#endif
#endif
...
#define DDCAKEY_SECTOR_SIZE         		0x200//512  For TPV Request 20151228
...
#define DDCDKEY_STATUS_ADDR         		(DDCAKEY_STATUS_ADDR    +DDCAKEY_STATUS_SIZE)
#define DDCDKEY_BUF_STATUS_ADDR     	(DDCAKEY_BUF_STATUS_ADDR+DDCAKEY_STATUS_SIZE)
#define DDCDKEY_SIZE                			128
#define DDCDKEYSET_START            		(DDCAKEYSET_START       +DDCAKEY_SECTOR_SIZE)
#define DDCDKEYSET_BUF_START        		(DDCAKEYSET_BUF_START   +DDCAKEY_SECTOR_SIZE)

#define DDCHKEY_SECTOR_SIZE         		0x400
#define DDCHKEY_STATUS_SIZE        		0x10
#define DDCHKEY_STATUS_ADDR        		(DDCDKEY_STATUS_ADDR     +DDCDKEY_STATUS_SIZE)
#define DDCHKEY_BUF_STATUS_ADDR    	(DDCDKEY_BUF_STATUS_ADDR +DDCDKEY_STATUS_SIZE)
#define DDCHKEY_SIZE               			256
#define DDCHKEYSET_START           		(DDCDKEYSET_START        +DDCDKEY_SECTOR_SIZE)
#define DDCHKEYSET_BUF_START       		(DDCDKEYSET_BUF_START    +DDCDKEY_SECTOR_SIZE)
...
_MSFLASHDEC_ BYTE FlashReadHDCPByte(DWORD address);
#endif
