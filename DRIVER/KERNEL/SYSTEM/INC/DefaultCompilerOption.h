...
#define EarphoneDet_Enable            0		//  ¶ú»úÊä³ö
#endif
#ifndef SpeakerDet_Enable
#define SpeakerDet_Enable            0		//À®°ÈÊä³ö
#endif
...
//========================================================================
#ifndef 		ENABLE_AutoDetech			//2Èç¹û¿ªÆô£¬Çë×¢Òâ´ý»ú»½ÐÑ¹¦ÄÜµÄÌí¼Ó
...
#define PowerSaving_PinContal		0 //2 ½µµÍ´ý»ú¹¦ºÄ  8757 ·­×ª¿ª OD
#endif

#ifndef	Hotkey_BriCon_Enable          //1¿ì½Ý¼ü	ÁÁ¶È¶Ô±È¶Èµ÷½Ú
#define   Hotkey_BriCon_Enable		0
#endif

#ifndef	Hotkey_Bri_Enable          //1¿ì½Ý¼ü	ÁÁ¶Èµ÷½Ú
#define   Hotkey_Bri_Enable		0
#endif

#ifndef	Hotkey_Con_Enable          //1¿ì½Ý¼ü	¶Ô±È¶Èµ÷½Ú
#define   Hotkey_Con_Enable		0
#endif

#ifndef	Hotkey_ECO_Enable          //1¿ì½Ý¼ü	ECO µ÷½Ú
#define   Hotkey_ECO_Enable		0
#endif

#ifndef	Hotkey_DCR_Enable          //1¿ì½Ý¼ü	ECO µ÷½Ú
...
#ifndef	F_ShowVsync_Enable			//2 ÐèÒªÖ§³ÖFreesync
...
#ifndef Hot_Corss_ColorSelect			//2Ê®×Ö×¼ÐÇºì¡¢»Æ¡¢ÂÌÇÐ»»
#define Hot_Corss_ColorSelect			0
#endif

#ifndef Hot_Corss_FY_ColorSelect				//2Ãé×¼Æ÷3ÖÖ
#define Hot_Corss_FY_ColorSelect				0
#endif

#ifndef Hot_Corss_FND_Select				//2Ãé×¼Æ÷3ÖÖ
#define Hot_Corss_FND_Select				0
#endif

#ifndef	PresetMode_Enable			//1½«¿ªÆôGamma
...
#define Enable_Rotate180Func		Enable_8757DDRRotate180			//2(8757+DDR »­Ãæ·­×ª)
#endif


#ifndef OD_MODE_333_HSD					//1 9570 OD Ñ¡333 ²¢¿ªÆô
...
#ifndef   Enabe_DDCCI_FUNCTION			//2  ½ûÓÃ³ýÁËJRY DDCCI ÃüÁîÍâËùÓÐµÄÖ¸Áî
#define	Enabe_DDCCI_FUNCTION		1
#endif


#ifndef	LowBlueLightType					//2 µÍÀ¶¹âÄ£Ê½Ñ¡Ôñ
...
#ifndef	OsdHelpKeyType					//2 µÍÀ¶¹âÄ£Ê½Ñ¡Ôñ
...
#ifndef  HowShowFMenu
#define	HowShowFMenu				0   //2       0 Ö±½ÓÏÔÊ¾¹¤³§  1 mainmenu½ø¹¤³§
#endif

#ifndef   SWAP_LR_CHANNL					//2 ×óÓÒÉùµÀÇÐ»»
...
#ifndef USE_DAC_CODE						//2Ê¹ÓÃTable ±íµ÷½ÚÉùÒô´óÐ¡
...
/********************************************************************************************/
//2  OSD ·­ÒëÐÞ¸Ä
#ifndef		OD_Trans_Chinese				//2¸ü¸ÄOD·­ÒëÎªÏìÓ¦Ê±¼ä¼ÓËÙ
#define		OD_Trans_Chinese		0
#endif



#ifndef 		EN_HotInputSelect_ShowCenter				//2 Source Ñ¡Ôñ¾ÓÖÐÏÔÊ¾
...
#define		EN_ShowInfoUnderBurinInMenu		0		//2ÀÏ»¯²Ëµ¥ÏÔÊ¾ÐÅÏ¢
#endif
...
#define		OSD_NoHotKeyFunc			0					//2 OSD + - ¼üÎÞ¿ì½Ý¼ü¹¦ÄÜÊ¹ÄÜ
#endif


#ifndef		OSD_Trans_ECO_Mode								//3 Íâ¼Ó DCR ¸ÄÎª£ºActive Contrast£»
#define		OSD_Trans_ECO_Mode		0					//1Çé¾°Ä£Ê½ÐÞ¸ÄÎªPresetMode(PC£¬Movie£¬Game£¬ECO)
#endif
...
#define		Osd_Page2_Focus_Trans			0			//2 0:¾Û½¹ 1: ÏàÎ»
#endif
