...
#elif (DefBrightness==100)		//2  	ÁÁ¶ÈÄ¬ÈÏÒ»°Ù£¬Min Max ¾ù·ÖPWM·¶Î§£¬181013 modify
...
#if EANBLE_NEW_DCR_Functing
    BacklightNow = BacklightPrev = brightness;//æ›´æ–°å½“å‰èƒŒå…‰äº®åº¦å’Œä¸Šæ¬¡èƒŒå…‰äº®åº¦çš„å€¼
#endif
#if Brightness_Table_Enable
		brightness = BrightnessValueTable[brightness];//å–èƒŒå…‰å€¼è½¬æˆ16è¿›åˆ¶
#elif (DefBrightness==100)		//2  	ÁÁ¶ÈÄ¬ÈÏÒ»°Ù£¬Min Max ¾ù·ÖPWM·¶Î§£¬181013 modify
