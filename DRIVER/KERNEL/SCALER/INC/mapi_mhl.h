...
#if(MHL_DRIVER_VERSION >= MHL_DRIVER_U03)
#define DMHL_CDR_SW_MODE    0 // MHL CDR mode
#else
#define DMHL_CDR_SW_MODE    1 // MHL CDR mode
#endif
#define DMHL_PLL_DETECT_HW_MODE    (!DMHL_CDR_SW_MODE)    // power down dvi pll till clock stable, [0] SW mode; [1] HW mode
...
#if(MHL_DRIVER_VERSION >= MHL_DRIVER_U02)
...
#define DMHL_EDID_BYPASS    1 // MHL EDID is used HDMI EDID
...
#define GET_MHL_DEBOUNCE_TIMER()    (g_u16S2PatchCntFlag)//(g_u16S2PatchCnt)
#define SET_MHL_DEBOUNCE_TIMER(a)   ((a)?(g_u16S2PatchCntFlag=0, g_u16S2PatchCnt = a, g_u16S2PatchCntFlag=1):(g_u16S2PatchCntFlag=0))//(g_u16S2PatchCnt = a)

#define GET_MHL_TIMEOUT_TIMER()     (g_u16S2PatchCntFlag)//(g_u16S2PatchCnt)
#define SET_MHL_TIMEOUT_TIMER(a)    ((a)?(g_u16S2PatchCntFlag=0, g_u16S2PatchCnt = a *1010, g_u16S2PatchCntFlag=1):(g_u16S2PatchCntFlag=0))//(g_u16S2PatchCnt = a *1010)  // Add 1% more time
//#define DEC_MHL_TIMEOUT_TIMER()     (g_u16S2PatchCnt)

#define GET_MHL_ABORT_TIMER()       (g_u16S2PatchCntFlag)//(g_u16S2PatchCnt)
#define SET_MHL_ABORT_TIMER(a)      ((a)?(g_u16S2PatchCntFlag=0, g_u16S2PatchCnt = a *1010, g_u16S2PatchCntFlag=1):(g_u16S2PatchCntFlag=0))//(g_u16S2PatchCnt = a *1010)  // Add 1% more time
//#define DEC_MHL_ABORT_TIMER()       (g_u16S2PatchCnt)

#define GET_MHL_HANDLER_TIMER()     (g_u16MHLHandlerCntFlag)//(g_u16MHLHandlerCnt)
#define SET_MHL_HANDLER_TIMER(a)    ((a)?(g_u16MHLHandlerCntFlag=0, g_u16MHLHandlerCnt=a, g_u16MHLHandlerCntFlag=1):(g_u16MHLHandlerCntFlag=0))//(g_u16MHLHandlerCnt = a)
#define INC_MHL_HANDLER_TIMER()     (g_u16MHLHandlerCntFlag=0, g_u16MHLHandlerCnt++, g_u16MHLHandlerCntFlag=1)//(g_u16MHLHandlerCnt++)
#define DEC_MHL_HANDLER_TIMER()     (g_u16MHLHandlerCntFlag=0, g_u16MHLHandlerCnt--, g_u16MHLHandlerCntFlag=1)//(g_u16MHLHandlerCnt--)
...
//  Function Prototype
//-------------------------------------------------------------------------------------------------
extern BYTE xdata MHLExtenCountFlag;

#if ENABLE_MHL_COUNT
extern WORD xdata MHLActionCount; // 120718 coding test
#endif
