...
#ifndef DPS_GET_DATA_IN_MAINLOOP
#define DPS_GET_DATA_IN_MAINLOOP     1
#endif

#if DPS_GET_DATA_IN_MAINLOOP
extern xdata BYTE bDPSGetDataFlag;
#endif



extern xdata WORD  DPSGain;
extern xdata BYTE  DPSPWM ;
