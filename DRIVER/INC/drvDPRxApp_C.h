...
#if(ModelName==AOC_M2060PWQ)
#define DP_GUID_SW    0  //1:only DP1.2 SUPPORT GUID Modify by TPV FW Yanping Request 20160127
#else
#define DP_GUID_SW 1    // if 1: support GUID By SW reply   if 0 : don't support GUID by SW reply.
#endif
...
extern bit bDPRxStableTimeoutFlag; 	//130912 nick
#define SetDPRxStableTimeout(x) ((x)?(bDPRxStableTimeoutFlag=0,u16DPRxStableTimeout=x,bDPRxStableTimeoutFlag=1):(bDPRxStableTimeoutFlag=0)) 	//130912 nick
...
extern WORD _DPDATATYPE_ u16CDR_HPDCnt; 	//130912 nick
extern WORD _DPDATATYPE_ u16Skew_HPDCnt;// Add by CCJ 	//130912 nick
extern WORD _DPDATATYPE_ u16Audio_BWCnt; //   //20130716 	//130912 nick
extern WORD _DPDATATYPE_ u16HDCP_Cnt;    	//130912 nick
//130912 nick
