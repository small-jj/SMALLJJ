...
_MSOVDDEC_F_ void msOverDriverInit(void);
_MSOVDDEC_F_ void msLoadODTable( BYTE *pODTbl);
_MSOVDDEC_F_ void msOverDriveOnOff(Bool bEnable);
_MSOVDDEC_F_ void msRTE_LoadLUT(void);
_MSOVDDEC_F_ void msOverDriveDummy();
