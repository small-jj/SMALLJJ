...
{
#if (ModelName==HJP07BF2_Project)//  客户要求音频只有音频座子输入，如有以后，使用define 修改
    E_LINEOUT_FROM_DAC = 1,
#else
...
extern void msAudioLineOutGain( WORD val );
...
extern void msAudioGainForceToggle(void);//130529 nick add for Audio error issue
#endif //_MSDAC_H_
