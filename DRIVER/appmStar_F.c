...
Bool appmStar_SetPanelTiming( void )
{
    ...
    if( sclk )
    {
        ...
        #if DEBUG_PRINTDATA
        printData( "  u16OutVtt=%d", u16OutVtt );
        #endif
