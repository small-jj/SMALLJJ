...
#ifndef __bd_JRY_G156XW01__																//my
#define __bd_JRY_G156XW01__


#define  BoardName			"JRY-G156XW01-V1"											//my
...
#define Init_BrightnessPWM()    { MEM_MSWRITE_BYTE_MASK(REG_020A,BIT0,BIT0);MEM_MSWRITE_BYTE_MASK(REG_0280,BIT0,BIT0);}

#if SpeakerDet_Enable
#define VolumePWM               _PWM1_ // Not Finishhed Yet in CHIP_TSUMC
#define Init_VolumePWM()        (MEM_MSWRITE_BYTE_MASK(REG_020A,BIT1,BIT1), MEM_MSWRITE_BYTE_MASK(REG_0280,BIT1,BIT1))
#endif

#define PowerKey                   		(_bit4_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))
#define Init_PowerKey()         		(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 1, BIT4))
...
#define DDC_Port_Sel()          		(MEM_MSWRITE_BYTE_MASK(REG_0260, BIT2, BIT3|BIT2))
...
#else
#define HarphoneDet_Pin           1
#define Init_HarphoneDet_Pin()    //,MEM_MSWRITE_BIT(_REG_GPIO0_SEL, 0, BIT1)
...
//130708 petit
#define hw_SetDDC_WP()                  (MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 1, BIT0),MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT0))//, DDCWPActiveFlag=1)
#define hw_ClrDDC_WP()                  (MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 0, BIT0),MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 0, BIT0))//, DDCWPActiveFlag=0)
#define Init_hwDDC_WP_Pin()         (MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 1, BIT0))//, DDCWPActiveFlag=1)
...
#define hw_SetBlacklit()                (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT0),MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT0), BackLightActiveFlag=1)    //-----tang
#define hw_ClrBlacklit()                (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT0),MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT0), BackLightActiveFlag=0)
#define Init_hwBlacklit_Pin()           MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT0)//,MEM_MSWRITE_BIT(REG_0262, FALSE, BIT5))// output enable

#define hw_SetPanel()                  MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT1),MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT1)    //---tang
#define hw_ClrPanel()                   MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT1),MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT1)
#define Init_hwPanel_Pin()           MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT1),MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT1)// output enable
...
#define hw_SetMute()                    ( MEM_MSWRITE_BIT(_REG_GPIO2_OUT, TRUE,  BIT7))
#define hw_ClrMute()                    ( MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT7))
#define Init_hwMute_Pin()			MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT7)
...
//DVI HPD
#define hw_Set_HdcpHpd()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT1))
#define hw_Clr_HdcpHpd()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT1))
#define Init_hwHDCP_Hpd_Pin()  (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT1)) //default low
//HDMI HPD
...
#define SAR2_EN     BIT2
#define SAR3_EN     BIT3
#define SARKEY_EN    (SAR0_EN|SAR1_EN)//(SAR1_EN|SAR2_EN)
...
#define KEYPAD_ADC_A        KEYPAD_SAR0//KEYPAD_SAR1
#define KEYPAD_ADC_B        KEYPAD_SAR1//KEYPAD_SAR2
