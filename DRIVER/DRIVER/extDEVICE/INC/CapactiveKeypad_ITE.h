/******************************************************************************
 ...
 [Reversion History]:
*******************************************************************************/
#ifndef _CAPACTIVEKEYPAD_ITE_H_
#define _CAPACTIVEKEYPAD_ITE_H_

extern BYTE xdata usCheckTouchKeyTimer_1s;	//110304 Modiy By ITE FAE
extern bit CheckTouchKeyFlag;				//110304 Modiy By ITE FAE
...
#define ITEREG_LED_MENU             BIT11
#define ITEREG_LED_PLUS             BIT9
#define ITEREG_LED_MINUS            BIT7
#define ITEREG_LED_EXIT             BIT4
#define ITEREG_LED_SELECT           BIT3

#define ITEREG_LED_POWER_BLUE       BIT1
#define ITEREG_LED_POWER_RED        BIT0

#define ITEREG_LED_FUNC                   ITEREG_LED_POWER_BLUE
#define ITEREG_LED_CONTROL          (BIT1|BIT0)

#if 0// PCB_715G4197_K0A //L2262	//110304 Modiy By ITE FAE
#define TPREG_POWER                 0x10
#define TPREG_MENU                  0x08
#define TPREG_PLUS                  0x02
#define TPREG_MINUS                 0x04
#define TPREG_AUTO                  0x01
#define TPREG_INPUT                 0x40
#endif

#if 1 //PCB_715G4842_K0B //51ID	//110304 Modiy By ITE FAE
...
#define TPREG_MUTEBUZZER            (TPREG_MINUS|TPREG_AUTO)
