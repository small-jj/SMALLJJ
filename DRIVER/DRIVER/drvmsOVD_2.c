...
#if defined(_MULTI_OD_)

void msLoad_MultiODTable(BYTE u8Index)
{
...
#if (PanelType==PanelLM230WF5_T2F2)
...
void msRTE_LoadLUT(void)
{
    ...
    if(RTEMode==RTE1)
    {
        ...
        #elif (PanelType==PanelLM270WF6_S2Z4)
            msWriteByte(REG_3123, 0x51);    //121129 Modify for TPV Request
        #elif (PanelType==PanelLM230WFA_S2Z4)   //120503 Modify
            msWriteByte(REG_3123, 0x50);    //121129 Modify for TPV Request
        #else
   	...
   	else if(RTEMode==RTE2)
    {
        ...
        #elif (PanelType==PanelLM270WF6_S2Z4)
            msWriteByte(REG_3123, 0x56);    //121129 Modify for TPV Request
        #elif (PanelType==PanelLM230WFA_S2Z4)   //120503 Modify
            msWriteByte(REG_3123, 0x55);    //121129 Modify for TPV Request
        #else
   	...
   	else if(RTEMode==RTE3)
    {
        msLoadODTable(tOverDrive3);
            ...
            msWriteByte(REG_3123, 0x5F);
        #elif (PanelType==PanelLM270WF6_S2Z4)
            msWriteByte(REG_3123, 0x5F);    //121129 Modify for TPV Request
        #elif (PanelType==PanelLM230WFA_S2Z4)   //120503 Modify
            msWriteByte(REG_3123, 0x5F);    //121129 Modify for TPV Request
        #else
            msWriteByte(REG_3123, 0x5F);
