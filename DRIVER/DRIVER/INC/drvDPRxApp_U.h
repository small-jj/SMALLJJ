...
#define DP_AudioMN_FineTune          	1    // If 1: Support DP audio fine tune,              If 0: not support DP audio fine tune
#define DP_PM_RECHECKSYNC	  		0    // If 1 :DP Wake up until Scaler HV valid.      If 0: DP wake until Scaler Aux valid.
#define DP_CheckSquelch              		0    // If 1 :check Fast Training each 3 sec.         If 0:  Always check Fast training..
#define DP_HDCPInfo					1    // If 1 :Can Know the HDCP encry from TX.   If 0:  didot check HDCP infor.
...
//==============================================
#define AUX_COMMON_Mode                   1    //   1: Power Off Aux Common mode when PM , 0: always Power On
#define AUX_8M                     			 0    //   0: Crystal ,  1: 8Mhx
//===============================================
...
typedef struct
{
    ...
    Bool        bEQloss;
   #if DP_FastTraining 
    Bool bSquelchWaitStable;        //2012.08.08 Stone.yu
    Bool bSquelchStable;
    #endif
...
#define HW_SET_AUDIO_MUTE_ENABLE()              msWriteBit(REG_1B06,TRUE,_BIT5);\
                                                                               msWriteBit(REG_05CC,TRUE,_BIT4);\
											 // msWriteBit(REG_05CC,FALSE,_BIT6);\

#define HW_SET_AUDIO_MUTE_DISABLE()      msWriteBit(REG_1B06,FALSE,_BIT5);\
...
#endif
extern WORD _DPDATATYPE_ DPTP1Cnt;
extern WORD _DPDATATYPE_ DPTP2Cnt;
extern WORD _DPDATATYPE_ CDR_HPDCnt;
extern WORD _DPDATATYPE_ Skew_HPDCnt;// Add by CCJ
...
#if DP_CheckSquelch
extern BYTE _DPDATATYPE_ u8EnableCheckSquelchCnt ;
extern BYTE _DPDATATYPE_ u8EnableCheckSquelchTimer ;
#endif
...
extern void DPRxDCHPD( Bool enable );  //130815 xiandi follow trunk
...
extern  DPAudioFreqType DPRxCheckAudioFreq( void );    //2012-05-16
#endif
