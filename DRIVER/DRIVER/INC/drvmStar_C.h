...
////////////////////////////////////////
#ifndef _DRVMSTAR_C_H_//130604 Modify
...
#define HDMI_EQ_VALUE                   0x0A  //20130909 nick modify
...
#define HDMI_PLL_LDO_VALUE              BIT12//130604 Modify
...
#define mStar_SetTimingGen(u16HDE_OP21, u16VDE_OP21, OP21_FreeRun)  // dummy
...
//#define WaitOutputFpllStable()  {TimeOutCounter=255;while(!(msRead2Byte(REG_3854)==0x1F4) && (TimeOutCounter));}//if(!DDCCI_MCCS_CMD_FLAG) {g_u16DelayCounter=5000;while(!(msRead2Byte(REG_3854)==0x1F4) && (g_u16DelayCounter));}
#define WaitOutputFpllStable()  {SetTimOutConter(255);while(!(msRead2Byte(REG_3854)==0x1F4) && (bTimeOutCounterFlag));}//if(!DDCCI_MCCS_CMD_FLAG) {g_u16DelayCounter=5000;while(!(msRead2Byte(REG_3854)==0x1F4) && (g_u16DelayCounter));}
