...
//IR PIN // IrControl
#define INT_IRQ_SOURCE_1_ENABLE(Enable)    (msWriteByteMask( REG_2B19, ((Enable)?(0):(BIT1)), BIT1 ))
#define INT_IRQ_SEL_HL_TRIGGER(Enable)    (msWriteByteMask( REG_2B21, ((Enable)?(BIT1):(0)), BIT1 )) //enable TRIGGER low
#define EXTINT1_EN_GPIO01(Enable)           (msWriteByteMask( _REG_GPIO0_OEZ, ((Enable)?(BIT1):(0)), BIT1 ))
...
// Efuse
// 0x000~0x12F(304Byte): HDCP Key
//  [0~4]: Bksv
//  [5~7]: Seed
//  [8~287]: HDCP key
//  [288~303]: profuction info
// 0x17F(1Byte): ADC bandgap trim vale
//  [7]: trim bit
//  [4:0]: trim value
#define HDCP_EFUSE_WRITE_ADDRESS(Value)    ( msWriteByte( REG_3A85, ((Value<<3)>>8) & 0x0F ), msWriteByte(REG_3A84, ((Value<<3)&0xFF)) )
#define HDCP_EFUSE_READ_DATA()    (msReadByte(REG_3A86))
#define HDCP_EFUSE_WAIT_READY()    ( (msReadByte(REG_3A85) & BIT6) == BIT6 )
#define HDCP_EFUSE_PROTECT_CODE()    (msWriteByte( REG_3A8A, 0xCD))
...
#define DVI_RESET(Enable)    (msWriteByteMask( REG_1752, (Enable)?(0x85):(0),  0x85))//130604 Modify

#define DVI_DE_IS_EXIST()  ((msReadByte(SC0_CA)&BIT5) == BIT5)
#define PIXEL_H_DE_COUNT()   ( msRead2Byte(REG_14DC))	//130627 nick
#define DP_INTERLACED_VIDEO_STREAM()    (msReadByte( REG_136B ) & BIT2) //20130909 nick modify
...
#define NEW_SOG_WAKEUP_FLUSH()          (msWriteByteMask(REG_ADC_ATOP_7A_L, BIT3, BIT3), msWriteByteMask(REG_ADC_ATOP_7A_L, 0, BIT3))
#endif
