...
//  Macro define
//-------------------------------------------------------------------------------------------------
#define GET_MHL_CABLE_PLUGGED()     (Bool)(gMHLInfo.ucCbusIndex & CBUS_CABLE_PLUG_FLAG)  //Nick check 20130123
...
#define SET_MHL_TIMEOUT_TIMER(a)    ((a)?(g_u16S2PatchCntFlag=0, g_u16S2PatchCnt = a *1010ul, g_u16S2PatchCntFlag=1):(g_u16S2PatchCntFlag=0))//(g_u16S2PatchCnt = a *1010)  // Add 1% more time
//#define DEC_MHL_TIMEOUT_TIMER()     (g_u16S2PatchCnt)

#define GET_MHL_ABORT_TIMER()       (g_u16S2PatchCntFlag)//(g_u16S2PatchCnt)
#define SET_MHL_ABORT_TIMER(a)      ((a)?(g_u16S2PatchCntFlag=0, g_u16S2PatchCnt = a *1010ul, g_u16S2PatchCntFlag=1):(g_u16S2PatchCntFlag=0))//(g_u16S2PatchCnt = a *1010)  // Add 1% more time
