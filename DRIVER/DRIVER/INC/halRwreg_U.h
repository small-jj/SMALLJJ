...
#define DP_INTERLACED_VIDEO_STREAM()    (msReadByte( REG_1FA5) & BIT2) //20130909 nick modify
...
#define VIDEO_AUTO_GAIN_SELECT(YUVColor)	 (msWriteByteMask(SC0_79,(YUVColor)?(BIT7):(0),BIT7)) //20150225 ALPHA
