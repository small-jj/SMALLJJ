...
#define HDCP_PORT_ENABLE()         (msWriteByteMask(SC0_BD,0,BIT7), msWriteByteMask(REG_28EF, BIT2, BIT2), msWriteByteMask( REG_28C0, 0, BIT7))
#define HDCP_PORT_DISABLE()        (msWriteByteMask(SC0_BD,BIT7,BIT7), msWriteByteMask(REG_28EF, 0, BIT2), msWriteByteMask( REG_28C0, BIT7, BIT7))
