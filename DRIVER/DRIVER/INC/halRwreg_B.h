...
#define INT_IRQ_LEDSARINT_ENABLE(Enable)    (msWriteByteMask( REG_2B18, ((Enable)?(0):(BIT5)), BIT5 )) 	//20130909 nick modify
#define INT_STATUS_LEDSARINT_ISR()               (_bit5_(msRegs[REG_2B28]))  							//20130909 nick modify
...
// dvi
#if HDMI_PRETEST
#define DVI_A_RCK_CTRL(On)  (msWriteByteMask( REG_PM_B2, ((On) ? 0 : 0), BIT0 ))
#define DVI_B_RCK_CTRL(On)  (msWriteByteMask( REG_PM_B2, ((On) ? 0 : 0), BIT1 ))// check 
#else
...
#define DVI_RESET(Enable)    (msWriteByteMask( REG_290E, (Enable)?(BIT4):(0),  BIT4)) 	//20130909 nick modify
#define DP_INTERLACED_VIDEO_STREAM()    (FALSE) //20130909 nick modify
...
#define SET_MAIN_WIN_FULL_RANGE()   (msWriteByteMask(SC3_70, BIT4, (BIT4|BIT2|BIT1|BIT0)))
#define SET_SUB_WIN_FULL_RANGE()   (msWriteByteMask(SC3_70, 0, (BIT4|BIT2|BIT1|BIT0)))
#define DISABLE_SUB_COLOR3X3()      (msWriteByte(SC3_70, 0))
...
#define OSD_TEXT_HI_ADDR_SET_BIT8()     msWriteByteMask(OSD2_AE, BIT3, BIT3|BIT2) //enable bit 8
#define OSD_TEXT_HI_ADDR_SET_BIT9()     msWriteByteMask(OSD2_AE, BIT2, BIT3|BIT2) //enable bit 9
#define OSD_TEXT_HI_ADDR_SET_BIT10()     msWriteByteMask(OSD2_AE, BIT2|BIT3, BIT3|BIT2) //enable bit 9
#define OSD_TEXT_HI_ADDR_CLR_TO_0()     msWriteByteMask(OSD2_AE,    0, BIT3|BIT2)
