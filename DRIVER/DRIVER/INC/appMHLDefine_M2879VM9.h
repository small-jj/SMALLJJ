...
code BYTE Mstar_MHL_EDID[256] =
{
    ...
    0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x05,0xE3,0x70,0x27,0x01,0x01,0x01,0x01,
    0x34,0x17,0x01,0x03,0x80,0x3C,0x22,0x78,0x2A,0x14,0xD5,0xA5,0x58,0x52,0xA2,0x26,
    ...
    0x45,0x00,0x56,0x50,0x21,0x00,0x00,0x1E,0x00,0x00,0x00,0xFD,0x00,0x32,0x4C,0x1E,
    0x53,0x11,0x00,0x0A,0x20,0x20,0x20,0x20,0x20,0x20,0x00,0x00,0x00,0xFC,0x00,0x47,
    0x32,0x37,0x37,0x30,0x0A,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x00,0x00,0x00,0xFF,
    0x00,0x31,0x33,0x32,0x32,0x31,0x33,0x31,0x32,0x33,0x31,0x32,0x33,0x33,0x01,0x8F,
...
#elif MainBoardType == MainBoard_7983_M0A     
    ,
...
#define MHL_VENDOR_ID               0x22     //OK
#define MHL_ADOPTER_ID              0x0473   //OK       // Mstar: 715
#define MHL_DEVICE_ID               0x2868 // Chip ID?   2579 for 25" 2479 for23.6"
...
#define MHL_USER_DEVICE_CAPABILITY  1   // User define device capacibility	//130605 nick
...
#define MHL_CABLE_SAR_DETECT_PORT0  hwDVI1Cable_Pin
#define SET_VBUS_CHARGE_PORT0()     SET_MHL_PS_CTRL_CHARGE1()
#define CLR_VBUS_CHARGE_PORT0()     CLR_MHL_PS_CTRL_CHARGE1()
#define SET_HDMI_HPD_PORT0()        hw_Set_HdcpHpd()
#define CLR_HDMI_HPD_PORT0()        hw_Clr_HdcpHpd()
#define SET_HPD_TRISTSTE_PORT0()    hw_Set_MHLTriStateHpd2()
...
#define MHL_CABLE_SAR_DETECT_PORT1  hwDVI0Cable_Pin
#define SET_VBUS_CHARGE_PORT1()     SET_MHL_PS_CTRL_CHARGE0()
#define CLR_VBUS_CHARGE_PORT1()     CLR_MHL_PS_CTRL_CHARGE0()
#define SET_HDMI_HPD_PORT1()        hw_Set_HdcpHpd2()
#define CLR_HDMI_HPD_PORT1()        hw_Clr_HdcpHpd2()
#define SET_HPD_TRISTSTE_PORT1()    hw_Set_MHLTriStateHpd()
...
#define MHL_LG_PRADA_DC_PATCH       1
...
#define MHL_SUPP_PPIXEL             1       ////OK
#define MHL_SUPP_ISLANDS            1
#define MHL_SUPP_VGA                1
#define MHL_AUD_2CH                 1
#define MHL_AUD_8CH                 0
#define MHL_VT_GRAPHICS             1       ////OK
#define MHL_VT_PHOTO                1       ////OK
#define MHL_VT_CINEMA               1       ////OK
#define MHL_VT_GAME                 1       ////OK
#define MHL_SUPP_VT                 1       ////OK
...
#define MHL_INT_SIZE                0x0F    ////OK(0xf)
#define MHL_STATE_SIZE              0x0F    ////OK(0xf)
...
//----------------------------------------------------------------------------------------------
#define MHL_TX_SEND_RCP_KEY_UP()                    (KeypadButton = CBUS_RCP_BTN_Plus)
#define MHL_TX_SEND_RCP_KEY_DOWN()              (KeypadButton = CBUS_RCP_BTN_Minus)
#define MHL_TX_SEND_RCP_KEY_ROOT_MENU()     (KeypadButton = CBUS_RCP_BTN_Menu)
#define MHL_TX_SEND_RCP_KEY_EXIT()                  (KeypadButton = CBUS_RCP_BTN_Exit)
...
#define IS_DOWN_KEY_PRESSED()   (KeypadButton == BTN_Minus)
#define IS_PLUS_KEY_PRESSED()   (KeypadButton == BTN_Plus)

#define IS_MENU_KEY_RELEASE()   (KeypadButton == (BTN_Menu | BIT7))
#define IS_EXIT_KEY_RELEASE()   (KeypadButton == (BTN_Exit | BIT7))
#define IS_DOWN_KEY_RELEASE()   (KeypadButton == (BTN_Minus | BIT7))
#define IS_PLUS_KEY_RELEASE()   (KeypadButton == (BTN_Plus | BIT7))
