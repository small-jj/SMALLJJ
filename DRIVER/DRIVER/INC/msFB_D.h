...
/*     Memory Allocation                 */
/*****************************************/
#if 0 	//20130909 nick modify
#if (FRAME_BFF_SEL == FRAME_BUFFER)
#if 0//ENABLE_VC_8_5   //nick mark for MIU SIZE 20130529
...
#endif
#elif (FRAME_BFF_SEL == FRAME_BFFLESS && ENABLE_TNR)
...
#if ENABLE_TNR||ENABLE_RTE||SPI_SSC_EN||(FRAME_BFF_SEL == FRAME_BUFFER)
