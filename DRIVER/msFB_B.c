...
*/
#include "global.h"
#if  CHIP_ID==CHIP_TSUMB//(FRAME_BFF_SEL == FRAME_BUFFER) || ENABLE_RTE
#define MSFB_DEBUG    0
...
void msSetupDDR3( void )
{
    ...
    reg_val_1 = tRP*MEMORY_CLOCK_MHZ/1000;
    reg_val_2 = tRCD*MEMORY_CLOCK_MHZ/1000;
    msWriteByte( REG_1208, ((reg_val_1&0x0F)<<4)|(reg_val_2&0x0F));
    msWriteByte( REG_1209, ((reg_val_1&0x10)<<7)|((reg_val_2&0x10)<<6) );
    reg_val_1 = tRAS*MEMORY_CLOCK_MHZ/1000;
    msWriteByteMask( REG_1209,reg_val_1,0x3F);
    reg_val_1 = tRTP*MEMORY_CLOCK_MHZ/1000;
    reg_val_2 = tRRD*MEMORY_CLOCK_MHZ/1000;
    msWriteByte( REG_120A, (reg_val_1<<4) | (reg_val_2));
    reg_val_1 = tRC*MEMORY_CLOCK_MHZ/1000;
    msWriteByte( REG_120B, reg_val_1 );
    reg_val_1 = tWR*MEMORY_CLOCK_MHZ/1000;
    reg_val_2 = tWL*MEMORY_CLOCK_MHZ/1000;
    msWriteByte( REG_120C, (reg_val_1<<4) | (reg_val_2));
    reg_val_1 = tWTR*MEMORY_CLOCK_MHZ/1000;
    reg_val_2 = tRTW*MEMORY_CLOCK_MHZ/1000;
    msWriteByte( REG_120D, (reg_val_2<<4)+reg_val_1 );
    reg_val_1 = tRFC*MEMORY_CLOCK_MHZ/1000;
