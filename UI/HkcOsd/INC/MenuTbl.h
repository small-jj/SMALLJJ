...
#define MainMenuText_XPos			0
#define MainMenuText_YPos			5
...
RadioTextType code DrawBrightnessTextRatio[] =
{
	...
	{dwiEnd | dwiRadioGroup | dwiMainTitle,		MainMenuText_XPos, 		MainMenuText_YPos + 2 * MAIN_BriContrast_ITEM,		MainMenu_ColorsText}
};
...
{
	// Flags,					XPos,	YPos,	DisplayText
	{dwiEnd | dwiRadioGroup | dwiMainTitle,		MainMenuText_XPos, 		MainMenuText_YPos + 2 * MAIN_Picture_ITEM,		MainMenu_BriContrastText}
};
...
{
	// Flags,					XPos,	YPos,	DisplayText
	{dwiEnd | dwiRadioGroup | dwiMainTitle,		MainMenuText_XPos, 		MainMenuText_YPos + 2 * MAIN_RGBColor_ITEM,		MainMenu_PictureText}
};
...
{
	// Flags,					XPos,	YPos,	DisplayText
	{dwiEnd | dwiRadioGroup | dwiMainTitle,		MainMenuText_XPos, 		MainMenuText_YPos + 2 * MAIN_Osd_ITEM,		MainMenu_Game_Pro_FeaturesText}
};
...
{
	// Flags,					XPos,	YPos,	DisplayText
	{dwiEnd | dwiRadioGroup | dwiMainTitle,		MainMenuText_XPos, 		MainMenuText_YPos + 2 * MAIN_Setting_ITEM,		MainMenu_Menu_settingsText}
};
...
{
	// Flags,					XPos,	YPos,	DisplayText
	{dwiEnd | dwiRadioGroup | dwiMainTitle,		MainMenuText_XPos, 		MainMenuText_YPos + 2 * MAIN_Misc_ITEM,		MainMenu_Other_settingsText}
};
