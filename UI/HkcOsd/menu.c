...
void Menu_InitAction(void)//寰�涓嬭蛋
{
...
#endif		
	{
     ...
     #else
   	 else if (UserPrefAutoTimes == 0 && SrcInputType < Input_Digital&&(!FactoryModeFlag))            //my
     #endif	 	
        {     
    ...
    printData("Menu_InitActionB4:%d", MenuPageIndex);
        ...
        ExecuteKeyEvent(MIA_RedrawMenu);							 //my
