...
Bool ExecuteKeyEvent(MenuItemActionType menuAction)
{
	...
	while (processEvent)
	{
		...
		/*					for(tempValue = SUB_TEXT_YPOS; tempValue < 0x0F; tempValue += 2)
							...
							MenuItemIndex = 0 ;	
		*/				Osd_Set256TextColor(COLOR_BLACK,COLOR_BLACK);
						Osd_DrawContinuesChar(20,4,SpaceFont,20);
						Osd_DrawContinuesChar(20,6,SpaceFont,20);
						Osd_DrawContinuesChar(20,8,SpaceFont,20);
						Osd_DrawContinuesChar(20,10,SpaceFont,20);
						Osd_DrawContinuesChar(20,12,SpaceFont,20);
