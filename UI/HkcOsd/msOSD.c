...
void LoadCommonFont(void)
{
	...
	mStar_LoadCompressedFont( GET_FONT_RAM_ADDR(MonoNumberStart), tOSDNumberFont, 0 );	//2023.06.21
	...
	OSD_WRITE_FONT_ADDRESS(0x00);
	#if CHIP_ID>=CHIP_TSUM2
	mStar_LoadCompressedFont( GET_FONT_RAM_ADDR(MonoGuageFontStar), tMonoGauge, 0 );
	//================================2color LoadFont==============================
	mStar_LoadCompressedFont( GET_FONT_RAM_ADDR(_2ColorMainIconStart), tHomeMainMenu_2ColorFont, 0 );
	#else
	...
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart));	//-------LT
	LoadCompressColorFont(&tBackGroundLT_4ColorFont, NULL, 2);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+4));	//-------RT
	LoadCompressColorFont(&tBackGroundRT_4ColorFont, NULL, 2);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+8));	//-------TOP02
	LoadCompressColorFont(&tBackGroundTOP02_4ColorFont, NULL, 2);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+12));//-------buttom1	
	LoadCompressColorFont(&tbuttom1_4ColorFont, NULL, 1);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+14));//-------buttom2
	LoadCompressColorFont(&tbuttom2_4ColorFont, NULL, 5);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+24));//-------buttom3
	LoadCompressColorFont(&tbuttom3_4ColorFont, NULL, 1);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+26));//-------TOP03
	LoadCompressColorFont(&tBackGroundTOP03_4ColorFont, NULL, 2);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+30));//-------TOP06
	LoadCompressColorFont(&tBackGroundTOP06_4ColorFont, NULL, 1);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+32));//-------TOP09
	LoadCompressColorFont(&tBackGroundTOP09_4ColorFont, NULL, 2);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+36));//-------TOP10
	LoadCompressColorFont(&tBackGroundTOP10_4ColorFont, NULL, 2);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+40));//-------TOP13
	LoadCompressColorFont(&tBackGroundTOP13_4ColorFont, NULL, 2);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+44));//-------LD
	LoadCompressColorFont(&tBackGround_LD_4ColorFont, NULL, 6);	
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+56));//-------RD
	LoadCompressColorFont(&tBackGround_RD_4ColorFont, NULL, 6);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+68));//-------刷新率
	LoadCompressColorFont(&tBackGround_SXL_4ColorFont, NULL, 4);
	OSD_WRITE_FONT_ADDRESS(LOBYTE(_4ColorFontStart+76));//-------分辨率
	LoadCompressColorFont(&tBackGround_FBL_4ColorFont, NULL, 4);
...
//Character Direct Write DisplayCode	字符直接写入显示代码
