  ...
  extern code BYTE tOSDFont1[882];
  extern code WORD tMonoFontDataAddr[55];
#else // No compress
  extern code WORD tOSDFont1[990]; // Format 2: 1 word ==> 1 line
...
#define __COLOR_FONT_H
  ...
  #else
    extern code BYTE tColorFontData[54];
  #endif
