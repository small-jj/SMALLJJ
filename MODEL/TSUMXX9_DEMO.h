...
// BOARD SELECTION
////////////////////////////////////////////////////////////
#define CHIP_ID                CHIP_TSUM9//CHIP_TSUMD
#define MainBoardType    	 MainBoard_TSUMP58CG_1//MainBoard_6148_M0A //MainBoard_6038_M0A // MainBoard_TSUMP387MT9_1 // ////, , , , 
...
#define PanelType 						PanelLM230HT11
...
#if MainBoardType == MainBoard_TSUMP58CG_1
#define INPUT_TYPE                  INPUT_1A1D1DP//INPUT_1A1D1H1DP
...
#define ENABLE_DP_EDID_IN_FLASH	1// 1	//121115 Modify
#define ENABLE_DP_HDCP_IN_FLASH	1// 1	//121115 Modify
#define ENABLE_DP_AUDIO           1
#define ENABLE_MHL_EDID_IN_FLASH			1	//enable mhl edid
...
#define BURST_MODE              		1
// INFORMATION
#define Model 					"TSUMXX9"//"M2870V"//20130427
#define ShowModelName 			_T,_S,_U,_M,_X,_X,_9
#define ChipName                "TSUMO58CHG-1"
#define FWVersion				"001"
#define F_FWVersion             _0,_0,_1
#define Version					001
#define ChangeDate				"20150629"
