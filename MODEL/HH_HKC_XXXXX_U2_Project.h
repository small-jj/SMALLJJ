...
#define DisplayLogo					NoBrand//CHONGHONG
...
#define JRY_FDDCCI_WriteEDID 			  (0&&JRY_Color_Tool_Functing)
...
#define Version						1
#define ChangeDate					"20180907"//"20180719"
...
#define OD_MODE_333_HSD    1//(((PanelWidth==2560)&&(PanelHeight==1440))?(0):( (PANEL_QUAD_PORT==0)?(1):(0)))      
#define ENABLE_FPS_RTS                  0
#define ENABLE_FREESYNC   		0
#define	HH_PivotKey_Enable			1
#define Hot_Corss_FY_ColorSelect				1
#define	PresetMode_Enable		1   //2 ½«¿ªÆôGAMMA
