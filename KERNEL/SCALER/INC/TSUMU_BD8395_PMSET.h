...
#define PM_POWEROFF_WAKEUP_GPIO     				0  //0
...
#define EN_DVI_DET_C        _BIT1
#define EN_DVI_DET_AB       _BIT0

#define EN_DVI_DET_SET      EN_DVI_DET_AB|EN_DVI_DET_C
#define EN_DVI_DET_MASK     EN_DVI_DET_AB|EN_DVI_DET_C
//---------------------------------------
...
#define PM_POWERKEY_INT	PMGPIO03_INT//	GPIO27_INT
#define EN_GPIO_DET_SET    ( EN_PMGPIO03_DET )
...
#define INV_GPIO_POL_SET  	( INV_PMGPIO03_POL )
