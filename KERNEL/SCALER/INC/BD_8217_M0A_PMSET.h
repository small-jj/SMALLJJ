#ifndef _MS_7250_M0D_H
#define _MS_7250_M0D_H
...
#define PM_SUPPORT_WAKEUP_DVI      			(0) // (1)supports to DVI wakeup;                                            (0)doesn't support to DVI wakeup
...
#define PM_CABLE_DETECT_USE_SAR			(0)
