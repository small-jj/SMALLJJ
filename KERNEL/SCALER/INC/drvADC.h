...
#define OffsetValue     6

#ifndef OffsetValue
#define OffsetValue     12 // ADC offset adjustment //TPV maozhong request
#endif

#if ENABLE_AUTO_CLOLR_WITHOUT_INPUT && (OffsetValue == 12)
#define ADC_GAIN_FIX_LUM_0	15
#define ADC_GAIN_FIX_LUM_1	17
#define ADC_GAIN_FIX_LUM_2	19
#define ADC_GAIN_FIX_LUM_3	21
 #elif ENABLE_AUTO_CLOLR_WITHOUT_INPUT
#define ADC_GAIN_FIX_LUM_0	15
#define ADC_GAIN_FIX_LUM_1	17
#define ADC_GAIN_FIX_LUM_2	19
#define ADC_GAIN_FIX_LUM_3	21
#else
#define ADC_GAIN_FIX_LUM_0	0
#define ADC_GAIN_FIX_LUM_1	0
#define ADC_GAIN_FIX_LUM_2	0
#define ADC_GAIN_FIX_LUM_3	0
#endif
...
#define _DGAIN_CAL_WITH_INPUT_      0
#define _DGAIN_CAL_WITHOUT_INPUT_   (1&&ENABLE_AUTO_CLOLR_WITHOUT_INPUT)
