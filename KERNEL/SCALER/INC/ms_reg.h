...
#if CHIP_ID == CHIP_TSUMU||CHIP_ID == CHIP_TSUM2||CHIP_ID == CHIP_TSUMC||CHIP_ID == CHIP_TSUMD || CHIP_ID == CHIP_TSUM9|| CHIP_ID == CHIP_TSUMF// 130530 JUN Modify
#define SC_MASK_V   0xFFF
#else
#define SC_MASK_V   0x7FF
#endif
...
#define MASK_11BIT  0x7FF // 20121106 nick check
...
#define DDC_MCCS_IRQ_DET()          (_bit5_( msRegs[REG_2B29]))
#define DDC_MCCS_IRQ_EN()           (msRegs[REG_2B19] &= ~( BIT5 ))
#else
#define DDC_MCCS_IRQ_DET()          (_bit2_( msRegs[REG_2B2B]))
#define DDC_MCCS_IRQ_EN()           (msRegs[REG_2B1B] &= ~( BIT2 ))
#endif
