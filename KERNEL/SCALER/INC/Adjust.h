...
#define BRIGHTNESS_PWM_MIN_VALUE				 BRI_PRO_MIN_VALUE	//0
#define BRIGHTNESS_PWM_DEF_VALUE              	 BRI_PRO_DEF_VALUE//	cf
#define BRIGHTNESS_PWM_MAX_VALUE				 BRI_PRO_MAX_VALUE //fe
