...
//MOD
#define _REG_GPIOM_OUT      REG_0240 //GPIO_MOD0 ~ GPIO_MOD15 output value
#define _REG_GPIOM_OEZ      REG_0242 //GPIO_MOD0 ~ GPIO_MOD15 OEN control
#define _REG_GPIOM_IN       REG_0244 //GPIO_MOD0 ~ GPIO_MOD15 input value
...
#define _REG_GPIO1_OUT          REG_1B26    //GPIO10 ~ GPIO13 output value
#define _REG_GPIO1_OEZ          REG_1B28    //GPIO10 ~ GPIO13 OEN control
#define _REG_GPIO1_IN           REG_1B2A    //GPIO10 ~ GPIO13 input value
#define _REG_GPIO2_OUT          REG_1B2C    //GPIO20 ~ GPIO27 output value
#define _REG_GPIO2_OEZ          REG_1B2E    //GPIO20 ~ GPIO27 OEN control
#define _REG_GPIO2_IN           REG_1B32    //GPIO20 ~ GPIO27 input value
#define _REG_GPIO3_OUT          REG_1B34    //GPIO30 ~ GPIO35 output value
#define _REG_GPIO3_OEZ          REG_1B36    //GPIO30 ~ GPIO35 OEN control
#define _REG_GPIO3_IN           REG_1B38    //GPIO30 ~ GPIO35 input value
...
#if (CHIP_ID==CHIP_TSUMB||CHIP_ID==CHIP_TSUMY) // 130808 larry
#define _REG_PMGPIOSAR_OUT      REG_0220    //PMGPIO_SAR0 ~ PMGPIO_SAR3 output value
#define _REG_PMGPIOSAR_OEZ      REG_0220    //PMGPIO_SAR0 ~ PMGPIO_SAR3 OEN control
#define _REG_PMGPIOSAR_IN       REG_0221    //PMGPIO_SAR0 ~ PMGPIO_SAR3 input value
...
#define _REG_GPIOSAR_OUT      REG_1B54  //PMGPIO_SAR0 ~ PMGPIO_SAR3 output value
#define _REG_GPIOSAR_OEZ      REG_1B55  //PMGPIO_SAR0 ~ PMGPIO_SAR3 OEN control
#define _REG_GPIOSAR_IN       REG_1B55  //PMGPIO_SAR0 ~ PMGPIO_SAR3 input value
